...
//AGORA TEM QUE FAZE FRONT END NESSE INFERNO
...
<div class="card" style="width: 18rem;">
<!-- <img src="cocaina.jpg" class="card-img-top" alt="..."> -->
  <div class="card-body">
...
<div class="card" style="width: 18rem;">
<!-- <img src="dianobol.jpg" class="card-img-top" alt="..."> -->
  <div class="card-body">
    <p class="card-text"> bomba</p>
    <a href="" class="card-link">300 pila</a>
